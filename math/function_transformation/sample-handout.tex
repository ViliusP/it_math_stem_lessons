...
\begin{enumerate}
  ...
  \item Pagal 4 užduoties brėžinius, nurodykite funkcijos apibrėžimo
  ...
  \item Duotas funkcijos $y=f(x)$ grafikas (). Naudojantis transformacijomis
        žemiau pavaizduotų grafikų funkcijas.
\end{enumerate}
