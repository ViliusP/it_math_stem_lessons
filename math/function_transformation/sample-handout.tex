...
\begin{figure*}[p]
  \begin{fullwidth}
    ...
    \includegraphics[width=0.22\linewidth]{./graphs/quadratic_func_primary.pdf}\hspace{5pt}
    \includegraphics[width=0.22\linewidth]{./graphs/quadratic_func_transform_2.pdf}\hspace{5pt}
    \includegraphics[width=0.24\linewidth]{./graphs/quadratic_func_transform_3.pdf}
    \\\vspace{\baselineskip}

    % Second row
    \hspace*{-205pt} % Keep this value consistent with the first row
    \includegraphics[width=0.22\linewidth]{./graphs/quadratic_func_transform_4.pdf}\hspace{5pt}
    \includegraphics[width=0.24\linewidth]{./graphs/quadratic_func_transform_5.pdf}\hspace{5pt}
    \includegraphics[width=0.22\linewidth]{./graphs/quadratic_func_transform_6.pdf}
  \end{fullwidth}
