...
\begin{enumerate}
      \item \textit{(2 taškai)} Kas yra centrinis kampas? Kas yra įbrėžtinis kampas? Koks ryšys tarp įbrėžtinio ir centrinio kampų, kai jie remiasi į tą patį lanką? Koks ryšys tarp dviejų įbrėžtinių kampų, kurie remiasi į tą patį lanką? 
\end{enumerate}
...
\begin{minipage}{0.5\textwidth}
      \begin{enumerate}
            ...
            \item \textit{(2 taškai)} Apskaičiuokite kampus $BCA$ ir $BAC$, kai
                  kampo $ABC$ dydis yra $50^\circ$, BA - skersmuo. Taškas $O$ - apskritimo centras.
...
\begin{minipage}{0.5\textwidth}
      \begin{enumerate}
            ...
            \item \textit{(1 taškas)} Apskaičiuokite kampą $BCA$, kai kampo
                  $BOA$ dydis yra $76^\circ$. Taškas $O$ - apskritimo centras. \\
...
\begin{enumerate}
      ...
      \item \textit{(3 taškai)} Apskaičiuokite užbrūkšniuotos figūros plotą:
            ...
            \begin{tikzpicture}[scale=.65]
                  ...
                  % Mark the angle
                  \pic [draw, angle radius=0.35cm, angle eccentricity=1.45,
                        "$110^\circ$"]
                  {angle=P--O--K};
