...
\begin{enumerate}
      ...
      \item \textit{(2 taškai)} Centrinis kampas yra $28^\circ$ didesnis už
            įbrėžtinį kampą, besiremiantį į tą patį lanką. Apskaičiuokite
            abiejų kampų
            dydžius.
      \item \textit{(4 taškai)} Naudodamiesi brėžinio duomenis, nustatykite,
      ...
      \item \textit{(3 taškai)} Apskaičiuokite užbrūkšniuotos figūros plotą ($0,1\;cm^2$ tikslumu), kai į ketvirtadalį skritulio įbrėžtas kvadratas, kurio plotas yra $16\;cm^2$.
